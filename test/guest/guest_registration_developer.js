...
describe('Guest Registration', function() {
    ...
    it('Guest should register successfully', async function() {
        ...
        await driver.findElement(By.xpath(getRegistrationElement.developerRegisterButtonXpath)).click();

        let registrationUrl = await driver.getCurrentUrl();
        registrationUrl.should.equal("http://127.0.0.1:8000/register/pengembang");
        ...
        swalText.should.equal("Akun Pengembang Anda berhasil dibuat!");
    ...
    it ('Guest should not register with invalid email format', async function () {
        ...
        currentUrl.should.equal("http://127.0.0.1:8000/register/pengembang");
    ...
    it ('Guest should not registered with profile picture file size more than 2MB', async function () {  
        ...
        expect(currentUrl).to.equal("http://127.0.0.1:8000/register/pengembang");
    });
});
